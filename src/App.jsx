...
export default function App() {
  return (
    ...
    // ал қате шыққанда контекст оған қолжетімді болуы керек. ThemeProvider де
    // сол себепті сыртта тұр: қате беті де дұрыс тақырыппен көрінуі керек.
    <I18nProvider>
      <ThemeProvider>
        <ErrorBoundary>
          <BrowserRouter>
            <AuthProvider>
              ...
              <UIProvider>
                ...
                <Routes>
                  ...
                  />
                  {/* Хаттағы сілтемелер. Кірмеген қолданушыға да ашық:
