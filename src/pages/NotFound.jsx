...
export default function NotFound() {
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-white px-6 py-12 text-center dark:bg-slate-950">
      ...
      <p className="mt-10 text-sm font-semibold tracking-wide text-brand-600 uppercase sm:mt-16 dark:text-brand-400">
        404
      </p>
      <h1 className="mt-4 text-3xl font-semibold tracking-tight text-balance text-slate-900 sm:text-5xl dark:text-slate-100">
        {t('notFound.title')}
      </h1>
      <p className="mt-5 max-w-md text-base text-pretty text-slate-600 sm:mt-6 sm:text-lg dark:text-slate-400">
        {t('notFound.body')}
      </p>
